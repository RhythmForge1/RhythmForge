  ...
  useEffect(() => {
    if (selectedProject) {
      const fetchStageData = async () => {
        try {
          const response = await axios.get(`http://localhost:8080/api/projects/${selectedProject}`);
...
console.log("Extracted Token:", token);
      ...
      const response = await axios.patch(
        `http://localhost:8080/api/projects/${selectedProject}/stages/${stage.stage}`,
        { status: "In-Progress" },
        {
          headers: {
...
console.log("Extracted Token:", token);
      ...
      const response = await axios.patch(
        `http://localhost:8080/api/projects/${selectedProject}/stages/${stageData[currentStageIndex]?.stage}`,
        rejectionPayload,
        {
          headers: {
